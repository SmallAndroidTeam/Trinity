...
//    进入主界面
    ...
    private void showDialogTipUserRequestPermisson() {
        ...
        new AlertDialog.Builder(LoadingActivity.this).setTitle("读取权限不可用").setMessage("由于需要读取本地音乐和视频信息;\n否则，您将无法正常使用")
    ...
    private void showDialogTipUserGoToAppSetting() {
        alertDialog = new AlertDialog.Builder(LoadingActivity.this).setTitle("读取权限不可用").setMessage("请在-应用设置-权限，允许使用读取权限")
                .setPositiveButton("立即开启", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //跳到应用设置界面
