package of.meida.bq.heartRate.chartview;
...
public class CharterBase extends View {
    ...
    ArrayList<of.meida.bq.heartRate.chartview.ChartEntity> values = new ArrayList<>();
    float[] valuesData;
    String[] valuesText;
...
//        animInterpolator = new DecelerateInterpolator();
    ...
    public ArrayList<of.meida.bq.heartRate.chartview.ChartEntity> getValues() {
        return values;
    }

    public void setValues(ArrayList<of.meida.bq.heartRate.chartview.ChartEntity> values) {
        this.values = values;
    ...
    private void getValues(ArrayList<of.meida.bq.heartRate.chartview.ChartEntity> values) {
    ...
    private void getMaxMinValues(ArrayList<of.meida.bq.heartRate.chartview.ChartEntity> values) {
        if (values != null && values.size() > 0) {
    ...
    private void initValuesTarget(ArrayList<of.meida.bq.heartRate.chartview.ChartEntity> values) {
